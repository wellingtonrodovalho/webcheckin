...
export const TRANSLATIONS: Record<Language, TranslationDict> = {
  pt: {
    ...
    guestSelfieHint: "* Selfie com o documento de identidade (ambos visíveis)",
  ...
  en: {
    ...
    guestSelfieHint: "* Selfie holding your ID document (both must be clearly visible)",
  ...
  es: {
    ...
    guestSelfieHint: "* Selfie sosteniendo su documento de identidad (ambos legibles)",
